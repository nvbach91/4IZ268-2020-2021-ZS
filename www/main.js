...
console.log(x = theGreatestNumber(119, 315));
console.log(x = theGreatestNumber(-12, 35));
console.log(x = theGreatestNumber(11.3, 13.4));
console.log(x = theGreatestNumber(3 / 7, 2 / 8));
...
// Solution here
console.log('8. ');
function circleVolume(hight, radius) {
    if (hight <= 0 || radius <= 0) {
