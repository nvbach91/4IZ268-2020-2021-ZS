$(function () {
    ...
    function saveCur() {
        ...
        if (isSavedCurrency) {
           ...
           var button=document.createElement('button');
            button.id = curName;
            button.setAttribute("onclick", "display('" + curName + "','"+ curValue + "','"+ D + "','" + rates + "');");
            ...
            var button=document.createElement('button');
                button.id = curName;
                button.setAttribute("onclick", "display('" + curName + "','"+ curValue + "','"+ D + "');");
            button.appendChild(document.createTextNode(curName));
    ...
    function checkCur() {
        if (localStorage.getItem('currrency')) {
            ...
            button.setAttribute("onclick", "display('" + Cur[i]['name'] + "','"+ Cur[i]['val'] + "','"+ Cur[i]['uniq'] + "');");
...
function display(curName, curValue, D, rates) {
    $.ajax({
